...
urlpatterns = [
  ...
  path("stations/<pk>/update/", views.UpdateStationView.as_view(), name="update_view")
  path("stations/<pk>/delete/", views.DeleteStationView.as_view(),name="delete_view")
  path("stops/", views.StopsView.as_view(), name="stops")
  path("stops/new/", views.CreateStopsView.as_view(), name="create_stop")
